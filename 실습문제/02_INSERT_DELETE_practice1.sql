...
-- 11번째 빠나쁘레쏘 '경기도 고양시' 031-123-456
...
--- 12번째 로맨틱블루 부산 해운대구 051-987-6543;
...
---- 주의점 : NOT NULL 은 선택적으로 작성 불가 필수로 작성해야하는 컬럼.

-- PRIMARY KEY -> 고유의 숫자값을 가지는 키 가입한 명단 순서 NULL
--- 트리거 시퀸스 -> ORACLE PRIMARY KEY 는 자동으로 번호를 측정해주는 동작을 설정해줘야함.

INSERT INTO EATS (CAFE_ID, CAFE_NAME)
			VALUES (15, '빈포레스트');
